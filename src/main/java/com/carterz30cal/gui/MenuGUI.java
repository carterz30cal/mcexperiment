...
public class MenuGUI extends AbstractGUI 
{
	...
	public void update() {
		...
		inventory.setSlot(ItemFactory.buildCustom("RED_STAINED_GLASS_PANE", "REDCurrently unavailable!", null), TALIS_POS);
		...
		owner.getSackUsed() + "WHITE/GOLD" + owner.getSackSize() + "GRAY items."), 
					SACK_POS);
		}
