...
public class CommandItem implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command arg1, String label, String[] args) 
	{
        ...
        else if (sender instanceof Player player)
		{
            ...
            ItemFactory.FactoryBuildContext context = new ItemFactory.FactoryBuildContext(PlayerManager.players.get(player.getUniqueId()));
            ItemFactory.update(built, context);
