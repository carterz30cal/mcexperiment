...
public class AbilitySeraphSummonCorrupt extends ItemAbility {

	public AbilitySeraphSummonCorrupt(GamePlayer owner) {
		super(owner);
	...
	public List<String> description()
	{
		...
		l.add("DARK_PURPLECorrupt challenge - Difficult!");
	...
	public void onRightClick()
	{
		...
		req.addRequirement(new ItemReq("seraph_summon_corrupted", 1));
		
		if (req.areRequirementsMet(owner) && BossWaterwaySeraph.attemptStartCorruptFight())
		{
			req.execute(owner);
		}
	}
